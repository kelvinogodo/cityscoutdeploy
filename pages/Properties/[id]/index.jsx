      ...
      <section className='page'>    
          <div className="left-description-body">
            ...
            <div className="lower-grid">
              <Image src={`${property.sideViewImage}`} className='lower-prop-img' alt="" width={420} height={420} placeholder='blur' blurDataURL={`${property.sideViewImage}`}/>
              <Image src={`${property.backViewImage}`} alt="" className='lower-prop-img' width={420} height={420} placeholder='blur' blurDataURL={`${property.backViewImage}`}/>
            </div>
          </div>
